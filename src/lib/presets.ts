...
export const TEMPLATES: Template[] = [
  { id: "iphone-hero", name: "iPhone hero", device: "iphone-17-pro", finish: "cosmic-orange", scene: "custom", camera: { x: -18, y: 14, z: 0, fov: 24, zoom: 1, panX: 0, panY: 0 }, rot: { x: 0, y: 0, z: 0 }, motion: "drift", aspect: "4:5", background: { type: "preset", preset: "glaze" }, swatch: ["#f6efe8", "#d7b79c"] },
  { id: "iphone-detail", name: "iPhone detail", device: "iphone-17", finish: "black", scene: "custom", camera: { x: -24, y: 48, z: 0, fov: 24, zoom: 1.9, panX: 0.06, panY: -0.17 }, rot: { x: 0, y: 0, z: 0 }, motion: "scan-lr", aspect: "16:9", background: { type: "preset", preset: "whisp" }, blur: { mode: "radial", strength: 6, focusSize: 0.5, falloff: 0.3, bokeh: true, focusX: 0.5, focusY: 0.55 }, swatch: ["#f4f4f6", "#c5c9d3"] },
  { id: "concrete-macbook", name: "Concrete MacBook", device: "macbook-pro-14", finish: "space-black", scene: "concrete", camera: { x: -28, y: 18, z: 0, fov: 26, zoom: 1.1, panX: 0, panY: 0.02 }, rot: { x: 0, y: 12, z: 0 }, motion: "low-pan-up", aspect: "16:9", swatch: ["#3a3a3a", "#151515"] },
  { id: "darkroom-macbook", name: "Dark room MacBook", device: "macbook-air-15", finish: "midnight", scene: "darkroom", camera: { x: 22, y: 12, z: 0, fov: 24, zoom: 1.15, panX: 0, panY: 0.02 }, rot: { x: 0, y: -18, z: 0 }, motion: "slow-zoom-out", aspect: "16:9", swatch: ["#0c0c0c", "#2a2f39"] },
  { id: "studio-ipad", name: "Studio iPad", device: "ipad-pro-13", finish: "space-black", scene: "studio", camera: { x: -20, y: 16, z: 0, fov: 24, zoom: 1, panX: 0, panY: 0 }, rot: { x: 0, y: 10, z: 0 }, motion: "orbit", aspect: "4:3", swatch: ["#dcdcdc", "#f0f0f0"] },
  { id: "watch-aurora", name: "Watch aurora", device: "apple-watch-46", finish: "jet-black", scene: "custom", camera: { x: -26, y: 20, z: 8, fov: 24, zoom: 1.1, panX: 0, panY: 0 }, rot: { x: 0, y: 0, z: 0 }, motion: "orbit", aspect: "1:1", background: { type: "preset", preset: "aurora" }, swatch: ["#0c1224", "#3a6b8a"] },
  { id: "display-gallery", name: "Gallery display", device: "studio-display", finish: "silver", scene: "gallery", camera: { x: -14, y: 8, z: 0, fov: 22, zoom: 1, panX: 0, panY: 0 }, rot: { x: 0, y: 6, z: 0 }, motion: "push-in", aspect: "16:9", swatch: ["#f6f6f6", "#dcdcdc"] },
  ...
  { id: "air-mint", name: "Air on mint", device: "iphone-air", finish: "sky-blue", scene: "custom", camera: { x: 20, y: 12, z: 4, fov: 24, zoom: 1, panX: 0, panY: 0 }, rot: { x: 0, y: -20, z: 0 }, motion: "flip", aspect: "9:16", background: { type: "preset", preset: "mint" }, swatch: ["#e6f4ec", "#8fd1ae"] },
  { id: "imac-noir", name: "iMac noir", device: "imac-24", finish: "blue", scene: "darkroom", camera: { x: -16, y: 10, z: 0, fov: 24, zoom: 1, panX: 0, panY: 0.04 }, rot: { x: 0, y: 8, z: 0 }, motion: "out-and-back", aspect: "16:9", swatch: ["#0c0c0c", "#2c5e9a"] },
];
